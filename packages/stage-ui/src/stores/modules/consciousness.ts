...
import { ALBION_LLM_MODEL, ALBION_LLM_PROVIDER_ID } from '../../albion-defaults'
...
export const useConsciousnessStore = defineStore('consciousness', () => {
  ...
  // State
  const activeProvider = useLocalStorageManualReset<string>('settings/consciousness/active-provider', ALBION_LLM_PROVIDER_ID, persistenceOptions)
  const activeModel = useLocalStorageManualReset<string>('settings/consciousness/active-model', ALBION_LLM_MODEL, persistenceOptions)
