...
import { ALBION_TTS_MODEL, ALBION_TTS_PROVIDER_ID } from '../../albion-defaults'
...
export const useSpeechStore = defineStore('speech', () => {
  ...
  // State
  const activeSpeechProvider = useLocalStorageManualReset<string>('settings/speech/active-provider', ALBION_TTS_PROVIDER_ID, persistenceOptions)
  const activeSpeechModel = useLocalStorageManualReset<string>('settings/speech/active-model', ALBION_TTS_MODEL, persistenceOptions)
  const activeSpeechVoiceId = useLocalStorageManualReset<string>('settings/speech/voice', ALBION_TTS_MODEL, persistenceOptions)
